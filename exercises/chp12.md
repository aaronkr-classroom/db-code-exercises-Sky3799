...
20. CREATE VIEW 명령을 이용해서 기몬 테이블로부터 만들어지는 테이블 >>> 뷰
...
>>> ALTER TABLE lab ADD COLUMN lab_size INTEGER DEFAULT 50;
...
DROP VIEW IF EXISTS com_lab_view;
DROP INDEX IF EXISTS room_id_idx;
DROP TABLE IF EXISTS lab;
DROP SEQUENCE IF EXISTS lab_num_seq;
